...
PYTHONUNBUFFERED=1 python3 -m verl.trainer.main_ppo \
  data.train_files=$PWD/data/empty_wordle.jsonl \
  data.val_files=$PWD/data/empty_wordle.jsonl \
  ...
  actor_rollout_ref.rollout.tool_kwargs.tools_config_file=./configs/wordle_tool.yaml \
...
PYTHONUNBUFFERED=1 python3 -m verl.trainer.main_ppo \
 ...
 trainer.experiment_name='qwen2.5-0.5b-single-gpu' \
